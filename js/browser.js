...
(function() {
  ...
  function formatActions(actionTags) {
    ...
    // If no explicit casting cost tags (only Sustain), default is 2-action
  ...
  function renderTags(spell) {
    ...
    // 6. Weaknesses imposed (with W: prefix)
